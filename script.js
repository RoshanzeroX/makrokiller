document.addEventListener("DOMContentLoaded", () => {
    ...
    const incomeButton = document.getElementById("incomeButton"); // เพิ่ม: incomeButton เข้ามา
    ...
    // เพิ่ม: Event Listener สำหรับ incomeButton
    if (incomeButton) {
        incomeButton.addEventListener("click", () => {
            window.location.href = "income.html"; // พาไปที่หน้า income.html
        });
    }
